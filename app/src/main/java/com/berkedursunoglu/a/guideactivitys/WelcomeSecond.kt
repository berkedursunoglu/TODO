...
class WelcomeSecond : Fragment() {
    ...
    override fun onCreateView(
        ...
        dataBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_welcome_second,container,false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dataBinding.imagebuttonthity.setOnClickListener {
            val action = WelcomeSecondDirections.actionWelcomeSecond2ToWelcomeThirt()
