...
import com.berkedursunoglu.a.notes.EditFragmentDirections
...
class WelcomeFirst : Fragment() {
    ...
    override fun onCreateView(
        ...
        dataBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_welcome_first,container,false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dataBinding.imagebuttonfirst.setOnClickListener {
            val action = WelcomeFirstDirections.actionWelcomeFirstToWelcomeSecond2()
